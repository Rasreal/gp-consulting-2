...
function AdminLayout({ children }) {
    ...
    const checkAuth = async ()=>{
        try {
            ...
            const { data: profile, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('role').eq('id', session.user.id).single();
...
_s(AdminLayout, "WRXjUPutFw5O39gJHBZtWrpgCxI=");
_c = AdminLayout;
var _c;
...
//# sourceMappingURL=src_7ecc7834._.js.map