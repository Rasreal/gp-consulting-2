...
function AdminLoginPage() {
    ...
    const checkAuth = async ()=>{
        try {
            ...
            if (session?.user) {
                const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('role').eq('id', session.user.id).single();
    ...
    }["AdminLoginPage.useEffect"], []); // eslint-disable-line react-hooks/exhaustive-deps
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            const { data: profile, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('role').eq('id', data.user?.id).single();
...
_s(AdminLoginPage, "D1/XpDjt0Aoe0f5Jh9os2TrW2Po=", false, function() {
    return [
...
//# sourceMappingURL=_d5b0dce9._.js.map