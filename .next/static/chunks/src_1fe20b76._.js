...
"[project]/src/app/achievements/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AchievementsPage.useEffect": ()=>{
            async function fetchAchievements() {
                try {
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('achievements').select('*').order('created_at', {
                        ascending: true
                    });
                    if (error) {
...
_s(AchievementsPage, "DXxmu5sFr9q/40Ve1lcvtkXr0P4=");
_c = AchievementsPage;
var _c;
...
//# sourceMappingURL=src_1fe20b76._.js.map