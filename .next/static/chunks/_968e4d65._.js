...
"[project]/src/app/admin/industries/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function EditIndustryPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditIndustryPage.useEffect": ()=>{
            async function fetchIndustry() {
                try {
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('industries').select('*').eq('id', id).single();
                    if (error) throw error;
                    setIndustry(data);
                } catch (error) {
...
_s(EditIndustryPage, "sWinhJwbsdc+gcA+qxdZy0iNNLA=", false, function() {
    return [
...
_c = EditIndustryPage;
var _c;
__turbopack_context__.k.register(_c, "EditIndustryPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_968e4d65._.js.map