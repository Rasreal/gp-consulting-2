...
function AdminLoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            const { data: roleData, error: roleError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('role').eq('id', data.user?.id).single();
...
//# sourceMappingURL=_51178b91._.js.map