...
function ContentForm({ type, initialData, mode }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const table = `${type}s`; // industries, solutions, achievements
            let data = {
                ...formData
            };
            ...
            if (mode === 'create') {
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from(table).insert([
                    data
                ]);
                if (error) throw error;
            } else {
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from(table).update(data).eq('id', initialData.id);
                if (error) throw error;
            }
    ...
    const handleDelete = async ()=>{
        ...
        setIsLoading(true);
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from(`${type}s`).delete().eq('id', initialData.id);
            if (error) throw error;
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: "The solution you're looking for doesn't exist."
                }, void 0, false, {
                    fileName: "[project]/src/app/admin/solutions/[id]/page.tsx",
                    lineNumber: 48,
                    columnNumber: 9
...
//# sourceMappingURL=_a43ddd92._.js.map