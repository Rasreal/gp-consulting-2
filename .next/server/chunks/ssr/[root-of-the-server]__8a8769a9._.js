...
function AdminLayout({ children }) {
    ...
    const checkAuth = async ()=>{
        try {
            ...
            const { data: profile, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('role').eq('id', session.user.id).single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8a8769a9._.js.map