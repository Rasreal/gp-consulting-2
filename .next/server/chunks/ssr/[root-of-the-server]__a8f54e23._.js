...
"[project]/src/hooks/use-content.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function fetchContent(table, signal) {
    ...
    try {
        ...
        const query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from(table).select('*').order('created_at', {
            ascending: true
        });
        if (signal) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$content$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-content.ts [app-ssr] (ecmascript)");
...
function IndustriesPage() {
    const { data: industries, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$content$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useIndustries"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a8f54e23._.js.map